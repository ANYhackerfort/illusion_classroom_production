...
import { deleteMeeting, archiveMeeting, unarchiveMeeting } from '../../api/meetingApi';
...
export type MediaInfoCardProps = {
  ...
  handleArchieve?: (name: string) => void;
};
    ...
    >
      ...
      <div className="mic__body">
        ...
        <div className="mic__meta">
          ...
          <span className="mic__metaItem">{formatDuration(videoLengthSec)}</span>
        </div>
        ...
        <div className="mic__footer">
          <span className="mic__created">Created: {toDateLabel(createdAt)}</span>
        ...
        <div className="mic__actions">
          ...
          <Button
            ...
            onClick={(e) => {
              e.stopPropagation();
              if (handleArchieve) handleArchieve(name);
            }}
          >
            Archive
          </Button>
