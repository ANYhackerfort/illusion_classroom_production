...
interface MCQQuestionProps {
  answers: string[];
  botAnswers: BotAnswer[] | null;
  setBotAnswers: React.Dispatch<React.SetStateAction<BotAnswer[] | null>>;
    ...
    <div className="mcq-wrap">
      <div className="mcq-answers">
        {answers.map((answer, index) => {
          ...
          return (
            <div key={index} className="mcq-answer-box" onClick={() => handleClick(index)}>
